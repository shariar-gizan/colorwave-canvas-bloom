...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 bg-secondary/30 dark:bg-secondary/10 relative">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-accent/20 rounded-full filter blur-3xl -z-10"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-background rounded-full flex items-center justify-center border shadow-sm hover:shadow-md transition-all">
          ...
          <div className="bg-card shadow-lg rounded-xl p-8 border">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-secondary/30 border-0 focus:ring-2 focus:ring-primary/30 focus:outline-none transition"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg bg-secondary/30 border-0 focus:ring-2 focus:ring-primary/30 focus:outline-none transition resize-none"
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-purple-600 to-blue-500 py-3 hover:from-purple-700 hover:to-blue-600"
